...
Bu işlem Dockerfile üzerinden imajı oluşturur ve konteyneri 3001 portundan çalıştırır. Kendi `~/.kube/config` dosyanız konteynere salt-okunur olarak bağlanır. Ortam değişkenlerini değiştirerek portu veya SSE kullanımını özelleştirebilirsiniz.
